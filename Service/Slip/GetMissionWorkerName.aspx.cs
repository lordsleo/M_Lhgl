...
{
    public partial class GetMissionWorkerName : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (pmno == null)
                {
                    string warning = string.Format("参数Pmno不能为nul！举例：http://218.92.115.55/M_Lhgl/Service/Slip/GetMissionWorkerName.aspx?Pmno=20151010000161");
                ...
                string strSql =
                    string.Format("select a.workno,b.name from TB_PS_MISSION_FACTWORKER a, piecerate.tb_code_worker b where a.workno = b.workno and pmno='{0}' order by workno", pmno);
