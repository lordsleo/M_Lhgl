...
{
    public partial class GetCargoOwner : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string strSql =
                    string.Format("select distinct code_cargoowner,cargoowner,logogram from VW_BR_CARGOOWNER order by logogram");
                ...
                {
                    strArray[iRow, 0] = Convert.ToString(dt.Rows[iRow]["code_cargoowner"]);
